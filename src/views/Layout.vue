...
const menuItems = ref<MenuItem[]>([
  ...
  { name: '机顶盒分析', path: '/stb-analysis', icon: Monitor, children: [
    { name: '机顶盒总览', path: '/stb-dashboard' },
    { name: '流量分布明细', path: '/stb-traffic' },
    { name: 'IPTV质量监控', path: '/stb-iptv' },
    { name: '换台行为分析', path: '/stb-channel' },
  ]},
