...
import { Server, Box, Eye, FileText } from 'lucide-vue-next'
...
const resourceList = ref([
  { name: 'cloudflow-agent-abc12', namespace: 'cloudflow', status: 'Running', cpu: 45, memory: 62, network: 125000, icon: Box },
