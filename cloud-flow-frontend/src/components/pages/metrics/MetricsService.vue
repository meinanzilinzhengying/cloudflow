...
const serviceOption = computed(() => ({
  ...
  series: [
    { name: 'API Gateway', type: 'line', smooth: true, lineStyle: { color: '#2563eb', width: 2 }, data: [] },
    { name: 'Order Service', type: 'line', smooth: true, lineStyle: { color: '#f59e0b', width: 2 }, data: [] },
    { name: 'User Service', type: 'line', smooth: true, lineStyle: { color: '#22c55e', width: 2 }, data: [] },
  ],
}))
</script>
