...
func (idx *TSIDXIndex) GetStats() map[string]interface{} {
	return map[string]interface{}{
		...
		"add_count":    idx.stats.addCount.Load(),
		"search_count": idx.stats.searchCount.Load(),
		"hit_count":    idx.stats.hitCount.Load(),
		"miss_count":   idx.stats.missCount.Load(),
	}
}
